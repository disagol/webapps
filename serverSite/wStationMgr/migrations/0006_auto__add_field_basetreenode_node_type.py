...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseTreeNode.node_type'
        db.add_column(u'wStationMgr_basetreenode', 'node_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wStationMgr.NodeType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseTreeNode.node_type'
        db.delete_column(u'wStationMgr_basetreenode', 'node_type_id')
    ...
    models = {
        ...
        u'wStationMgr.basetreenode': {
            ...
            'node_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wStationMgr.NodeType']", 'null': 'True', 'blank': 'True'}),
        ...
        u'wStationMgr.nodetype': {
            ...
            'allowed_parents': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['wStationMgr.NodeType']", 'null': 'True', 'blank': 'True'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
