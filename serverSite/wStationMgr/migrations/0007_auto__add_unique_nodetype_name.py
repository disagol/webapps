...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NodeType', fields ['name']
        db.create_unique(u'wStationMgr_nodetype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'NodeType', fields ['name']
        db.delete_unique(u'wStationMgr_nodetype', ['name'])
